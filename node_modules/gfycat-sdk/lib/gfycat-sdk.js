...
var Gfycat = function () {
  ...
  (0, _createClass3.default)(Gfycat, [{
    ...
    value: function getTrendingCategories(_ref7, callback) {
      var _ref7$tagName = _ref7.tagName,
          tagName = _ref7$tagName === undefined ? 'trending' : _ref7$tagName,
          _ref7$gfyCount = _ref7.gfyCount,
          gfyCount = _ref7$gfyCount === undefined ? 1 : _ref7$gfyCount,
          _ref7$cursor = _ref7.cursor,
          cursor = _ref7$cursor === undefined ? null : _ref7$cursor;
